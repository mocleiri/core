...
import org.wicketstuff.dojo.application.DojoSettings;
import org.wicketstuff.dojo.application.IDojoApplication;
import org.wicketstuff.dojo.application.IDojoSettings;
...
//		modules.add(DOJOX_MODULE);
	...
	public static class DojoModuleImpl implements DojoModule {
		...
		/**
		 * @see org.wicketstuff.dojo.AbstractDefaultDojoBehavior.DojoModule#getPath()
		 */
		public String getPath()
		{
			return "";
