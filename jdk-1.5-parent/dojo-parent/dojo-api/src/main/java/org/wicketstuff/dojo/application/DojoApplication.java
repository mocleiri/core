...
public abstract class DojoApplication extends WebApplication implements IDojoApplication
{
	...
	/**
	 * @see org.wicketstuff.dojo.application.IDojoApplication#getDojoSettings()
	 */
	...
	/**
	 * @see org.wicketstuff.dojo.application.IDojoApplication#getLayer(org.apache.wicket.markup.html.WebPage)
	 */
