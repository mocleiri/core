...
import org.wicketstuff.dojo.util.JavaScriptEvent;
...
public class FxToggler extends AbstractAnimationBehavior
{
	...
	/**
	 * @see org.wicketstuff.dojo.AbstractRequireDojoBehavior#setRequire(org.wicketstuff.dojo.AbstractRequireDojoBehavior.RequireDojoLibs)
	 */
	@Override
	...
	/**
	 * @see org.wicketstuff.dojo.dojofx.AbstractAnimationBehavior#getAnimation()
	 */
	@Override
